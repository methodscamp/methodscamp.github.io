...
This year's edition is a work in progress. Click [here](/previous-editions/2023) to see last year's materials.
:::
...
**1 Friday morning: [Intro to R](https://methodscamp.github.io/01_r_intro.html)**
...
**2 Friday afternoon: [Tidy data analysis I](https://methodscamp.github.io/02_tidy_data1.html)**

-   Tidy data
-   Data wrangling with dplyr
-   Data visualization basics with `ggplot2`

**3 Monday morning: [Matrices](https://methodscamp.github.io/03_matrices.html)**
...
**4 Monday afternoon: [Tidy data analysis II](https://methodscamp.github.io/04_tidy_data2.html)**
...
**5 Tuesday morning: [Functions](https://methodscamp.github.io/05_functions.html)**
...
**6 Tuesday afternoon: [Calculus](https://methodscamp.github.io/06_calculus.html)**

-   Derivatives
-   Optimization
-   Integrals

**7 Wednesday: [Probability, statistics, and simulations](https://methodscamp.github.io/07_probability_stats_sims.html)**
...
**8 Thursday morning: [Text analysis](https://methodscamp.github.io/08_text_analysis.html)**

-   String manipulation with `stringr`
-   Simple text analysis and visualization with `tidytext`

**9 Thursday afternoon: [Wrap-up](https://methodscamp.github.io/09_wrapup.html)**
...
We thank previous Methods Camp instructors for their accumulated experience and materials, which we have based ours upon. All errors remain our own (and will hopefully be fixed with your help!).
