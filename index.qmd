...
**1 Thursday morning: [Intro to R](https://methodscamp.github.io/01_r_intro.html)**
...
**2 Thursday afternoon: [`tidyverse` basics I](https://methodscamp.github.io/02_tidy_data1.html)**

-   Tidy data
-   Data wrangling with dplyr
-   Data visualization basics with `ggplot2`

**3 Friday morning: [Matrices](https://methodscamp.github.io/03_matrices.html)**
...
**4 Friday afternoon: [`tidyverse` basics II](https://methodscamp.github.io/04_tidy_data2.html)**
...
**5 Monday morning: [Functions](https://methodscamp.github.io/05_functions.html)**
...
**6 Monday afternoon: [Calculus](https://methodscamp.github.io/06_calculus.html)**
...
**7 Tuesday: [Probability, statistics, and simulations](https://methodscamp.github.io/07_probability_stats_sims.html)**
...
**8 Wednesday morning: [Text analysis](https://methodscamp.github.io/08_text_analysis.html)**

-   String manipulation with `stringr`
-   Simple text analysis and visualization with `tidytext`

**9 Wednesday afternoon: [Wrap-up](https://methodscamp.github.io/09_wrapup.html)**
