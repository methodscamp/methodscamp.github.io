...
That's all for setup! We can now start coding. After opening our RStudio project, we'll begin by opening the `01_r_rstudio.qmd` file from the "Files" panel, in the bottom-right portion of RStudio. This is a Quarto document,[^rmarkdown] which contains both code and explanations (you can also read in the next chapter of this website). 
