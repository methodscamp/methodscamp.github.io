...
![](assets/images/Function_machine.jpg)

### Visualization

When graphed, we can't draw vertical line through a function. Why not?

![](assets/images/function_notfunction.jpg)
...
$$y=mx+b$$ - $m$ is the slope (for every one unit increase in $x$, $y$ increases $m$ units). - $b$ is the y-intercept: the value of $y$ when $x=0$. - More generally, $y=a+bx$ - $a$ is the intercept and $b$ is the slope.
...
$$m^{\log_m(a)} = a$$ \### Natural logarithms
