...
You can list the outcomes that result in a sum of 7:
...
There are 6 outcomes that result in a sum of 7. Thus,
...
```{r echo=FALSE}
# Plot the PMF
barplot(c(1, 2, 3, 4, 5, 6, 5, 4, 3, 2, 1) / 36, # sum of two dice
        names.arg = 2:12, 
        col = "skyblue", 
        xlab = "Sum of Two Dice", 
        ylab = "Probability", 
        main = "PMF of Sum of Rolling Two Dice",
        ylim = c(0, 0.2))
```
...
# Calculate the corresponding y-values (PDF values) using the dnorm function
y <- dnorm(x)

# Plot the normal distribution curve
plot(x, y, type = "l", lwd = 2, col = "blue", 
     xlab = "X", ylab = "Density", 
     main = "Normal Distribution Curve (PDF)")
